...
plugins_html = ['plugins/auto-wrap.py', 'plugins/cache_video.py', 'plugins/menu.py', 'plugins/redirection_first_page.py']
plugins_pdf = ['plugins/auto-wrap.py', 'plugins/cache_video.py', 'plugins/menu.py', 'plugins/generate_pdf.py']
